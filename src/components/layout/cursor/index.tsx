...
export default function Cursor() {
    ...
    return (
        <div
            ref={cursorRef}
            className={`fixed hidden md:flex w-12 h-12 rounded-full border-2 border-appGreen-300 pointer-events-none transition-opacity duration-200 ease-out 
...
//             ref={cursorRef}
//             className={`fixed hidden md:flex w-12 h-12 rounded-full border-2 border-appGreen-300 pointer-events-none transition-opacity duration-200 ease-out 
//                 ${isHidden ? "opacity-0 scale-90" : "opacity-100 scale-100 z-50"}`}
//         />
//     );
// }