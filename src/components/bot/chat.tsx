...
export default function ChatBot() {
    ...
    const isActive = pathname.startsWith("/resume");
    // const isActive = pathname.includes("/watch") || pathname.startsWith("/resume");

    return (
        <>
            <motion.button
                className={`fixed bottom-6 right-6 bg-primary text-primary-foreground hover:bg-gray-900 transition-colors rounded-full p-4 shadow-lg z-50 ${isActive ? 'hidden' : ''}`}
